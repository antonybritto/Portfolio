...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stores = __webpack_require__(272);
	...
	if ('serviceWorker' in navigator) {
	  navigator.serviceWorker.register('/sw.js').then(function (registration) {
	    ...
	    registration.pushManager.subscribe({
	      ...
	      window.pushEndPoint = sub.endpoint;
	      console.log('endpoint:', sub.endpoint);
	    }, function (err) {
	      window.pushEndPoint = null;
	      console.log('err:', err);
	    });
	  }).catch(function (err) {
	    // registration failed :(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHostObject = __webpack_require__(241),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var routes = _react2.default.createElement(
		...
		_react2.default.createElement(_reactRouter.IndexRedirect, { to: '/Portfolio' }),
		_react2.default.createElement(_reactRouter.Route, { path: 'Portfolio', component: _HomePage2.default })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Expertise = __webpack_require__(258);

	var _Expertise2 = _interopRequireDefault(_Expertise);

	var _Timeline = __webpack_require__(263);

	var _Timeline2 = _interopRequireDefault(_Timeline);

	var _Resume = __webpack_require__(266);
	...
	var OfflineTag = _react2.default.createClass({
		displayName: 'OfflineTag',
		getInitialState: function getInitialState() {
			return {
				isOnline: true
			};
		...
		updateOnlineStatus: function updateOnlineStatus(event) {
			var isOnline = window.navigator.onLine ? true : false;
		...
		render: function render() {
			return _react2.default.createElement(
				'div',
				null,
				!this.state.isOnline && _react2.default.createElement(
					'p',
					{ className: _Homepage2.default['offline'] },
					'You are mostly likely viewing this site offline'
				)
			);
		}
	});

	var AddToHome = _react2.default.createClass({
		displayName: 'AddToHome',
		getInitialState: function getInitialState() {
			return {
				deferredPrompt: null
			};
		...
		componentDidMount: function componentDidMount() {
			window.addEventListener('beforeinstallprompt', this.updatePromptStatus);
		},
		sendPushNotification: function sendPushNotification() {
			if (window.pushEndPoint) {
				var formData = new FormData();
				formData.append('subscriptionId', pushEndPoint);
				formData.append('endpoint', pushEndPoint);

				var headers = new Headers();
				headers.append("Content-Type", "application/json");
				headers.append("Authorization", "key=AIzaSyAQ5xawDGXFUN2mI3yM_wsPV_p45MIXtHY");
		...
		updatePromptStatus: function updatePromptStatus(e) {
			...
			if (this.state.deferredPrompt) {
				...
				this.state.deferredPrompt.userChoice.then(function (choiceResult) {
					...
					if (choiceResult.outcome == 'dismissed') {
						console.log('Dont do this to me!!!');
						sendPushNotification();
					} else {
						console.log('Shortcut added to your home screen!!!');
						sendPushNotification();
					}
					// We no longer need the prompt.  Clear it up.
					this.dismissAddToHome();
				});
			}
		},
		dismissAddToHome: function dismissAddToHome() {
			this.setState({
				deferredPrompt: null
			});
		},
		render: function render() {
			return this.state.deferredPrompt ? _react2.default.createElement(
				'ul',
				{ className: _Homepage2.default['addToHome'] },
				_react2.default.createElement(
					'li',
					null,
					_react2.default.createElement(
						'a',
						{ onClick: this.dismissAddToHome, className: _Homepage2.default['dismiss'] },
						'No Thanks'
					)
				),
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'a',
						{ onClick: this.addToHome, className: _Homepage2.default['add'] },
						'Add To Homescreen'
					)
				)
			) : null;
	...
	var Homepage = _react2.default.createClass({
		...
		componentDidMount: function componentDidMount() {
			this.props.dispatch((0, _events.fetchEvents)());
		},
		render: function render() {
			var list = [];
			...
			this.props.events && this.props.events.events.forEach(function (item, index) {
				list.push(_react2.default.createElement(
					'li',
					{ key: index, className: 'Grid-cell' },
					'Name : ',
					item.name,
			...
			return _react2.default.createElement(
				'div',
				{ className: _Homepage2.default['homePage'] },
				...
				_react2.default.createElement(OfflineTag, null),
				_react2.default.createElement(AddToHome, null)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(248), (function() { return this; }())))
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	    ...
	    */
	    ...
	    if ("function" === 'function' && __webpack_require__(252)['amd']) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(249), (function() { return this; }()), __webpack_require__(250)(module)))
...
/***/ function(module, exports) {
	...
	module.exports = {"homePage":"Homepage_homePage_1ALlq4","offline":"Homepage_offline_2yzVYD","addToHome":"Homepage_addToHome_2QHv6p","slideInUp":"Homepage_slideInUp_3Kq5nm","add":"Homepage_add_25yIIE","dismiss":"Homepage_dismiss_1RiSoY"};
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'ul',
						{ className: _Header2.default['horMenu'] },
						_react2.default.createElement(
							'li',
							null,
							'Antony Britto'
					...
					this.state.isExpanded && _react2.default.createElement(
						'ul',
						{ className: _Header2.default['verticalMenu'] },
						_react2.default.createElement(
							'li',
							null,
							_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'p',
						{ className: _Header2.default['quote'] },
						'Websites done right.'
					),
					'Myself a web developer from Bangalore, India. I enjoy building everything from small business sites to rich interactive web apps. If you are a business seeking a web presence or an employer looking to hire, you can get in touch with me.'
				)
			);
		}
	});
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"header":"Header_header_2zG4F7","horMenu":"Header_horMenu_3Z2tpr","verticalMenu":"Header_verticalMenu_3yd8kB","content":"Header_content_1rd2rz","quote":"Header_quote_2FoAkX"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Expertise = __webpack_require__(259);

	var _Expertise2 = _interopRequireDefault(_Expertise);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = _Expertise2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Expertise = __webpack_require__(260);
	...
	var Homepage = _react2.default.createClass({
		...
		render: function render() {
			...
			return _react2.default.createElement(
				'section',
				{ className: _Expertise2.default['expertise'], id: 'expertise' },
				_react2.default.createElement(
					'div',
					{ className: _Expertise2.default['header'] },
					_react2.default.createElement(
						'header',
						null,
						'SKILLS & EXPERTISE'
					...
					_react2.default.createElement(
						'p',
						null,
						'Ive been developing my skill–set to focus on what’s most suited to getting the job done quickly and effectively.'
					)
				),
				_react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						'ul',
						{ className: _Expertise2.default['skills'] },
						_react2.default.createElement(
							'li',
							{ className: _Expertise2.default['per85'] },
							' ',
							_react2.default.createElement(
								'span',
								{ className: _Expertise2.default['text'] },
								'HTML5'
							)
						),
						_react2.default.createElement(
							'li',
							{ className: _Expertise2.default['per80'] },
							' ',
							_react2.default.createElement(
								'span',
								{ className: _Expertise2.default['text'] },
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'li',
							{ className: _Expertise2.default['per70'] },
							' ',
							_react2.default.createElement(
								'span',
								{ className: _Expertise2.default['text'] },
						...
						_react2.default.createElement(
							'li',
							{ className: _Expertise2.default['per60'] },
							' ',
							_react2.default.createElement(
								'span',
								{ className: _Expertise2.default['text'] },
						...
						_react2.default.createElement(
							'li',
							{ className: _Expertise2.default['per30'] },
							' ',
							_react2.default.createElement(
								'span',
								{ className: _Expertise2.default['text'] },
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"expertise":"Expertise_expertise_2-HMG8","header":"Expertise_header_2GY9vu","skills":"Expertise_skills_1EPUVU","text":"Expertise_text_3t4P7E","per30":"Expertise_per30_2gJpLe","progress30":"Expertise_progress30_3udN-O","per60":"Expertise_per60_Ncvks9","progress60":"Expertise_progress60_1HNRQD","per70":"Expertise_per70_289082","progress70":"Expertise_progress70_Sagvwu","per80":"Expertise_per80_29lP7G","progress80":"Expertise_progress80_2OPsrV","per85":"Expertise_per85_1zIcKZ","progress85":"Expertise_progress85_28calE"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getEventsError = getEventsError;
	exports.removeEvents = removeEvents;
	exports.fetchEvents = fetchEvents;
	exports.addEventsSuccess = addEventsSuccess;
	exports.addEventsError = addEventsError;
	...
	function getEventsSuccess(data) {
					return { type: actions.GET_EVENTS_SUCCESS, data: data };
	}

	function getEventsError(error) {
					return { type: actions.GET_EVENTS_ERROR, error: error };
	}

	function removeEvents() {
					return { type: actions.GET_EVENTS_REMOVE };
	}

	function fetchEvents() {
					return function (dispatch) {
									dispatch(getEvents());
									return fetch('/events', { headers: headers, method: 'get' }).then(function (response) {
													return response.ok ? response.json() : Promise.reject(new Error('Api Error'));
									}).then(function (json) {
													dispatch(getEventsSuccess(json));
									}, function (err) {
													return dispatch(getEventsError(err));
									});
					};
	}

	function addEventsSuccess(msg) {
					return function (dispatch) {
									dispatch(fetchEvents());
					};
	}

	function addEventsError(error) {
					return { type: actions.ADD_EVENTS_ERROR, error: error };
	}

	function addEvents(data) {
					return function (dispatch) {
									return fetch('/events', { headers: headers, method: 'post', params: data }).then(function (msg) {
													dispatch(addEventsSuccess(msg));
									}, function (err) {
													return dispatch(addEventsError(err));
									});
					};
	}
...
/***/ function(module, exports) {
	...
	var GET_EVENTS = exports.GET_EVENTS = 'GET_EVENTS';
	...
	var GET_EVENTS_FAILURE = exports.GET_EVENTS_FAILURE = 'GET_EVENTS_FAILURE';
	var GET_EVENTS_REMOVE = exports.GET_EVENTS_REMOVE = 'GET_EVENTS_REMOVE';
	var ADD_EVENTS_SUCCESS = exports.ADD_EVENTS_SUCCESS = 'ADD_EVENTS_SUCCESS';
	var ADD_EVENTS_ERROR = exports.ADD_EVENTS_ERROR = 'ADD_EVENTS_ERROR';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timeline = _react2.default.createClass({
		...
		render: function render() {
			...
			return _react2.default.createElement(
				'section',
				{ className: _Timeline2.default['timeLine'], id: 'timeline' },
				_react2.default.createElement(
					'div',
					{ className: _Timeline2.default['header'] },
					_react2.default.createElement(
						'header',
						null,
					...
					_react2.default.createElement(
						'p',
						null,
						'I have 9+ years professional industry experience, working with startups to larger corporations.'
					)
				),
				_react2.default.createElement(
					'ul',
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'section',
							{ className: _Timeline2.default['timeCard'] },
							_react2.default.createElement(
								'p',
								{ className: _Timeline2.default['company'] },
								'Flipkart.com'
							),
							_react2.default.createElement(
								'p',
								{ className: _Timeline2.default['location'] },
								'Bangalore, India'
							),
							_react2.default.createElement(
								'p',
								{ className: _Timeline2.default['designation'] },
								'UI Engineer II',
								_react2.default.createElement('br', null),
								'April 2012 — Present'
							),
							_react2.default.createElement(
								'p',
								{ className: _Timeline2.default['description'] },
								'Worked closely with designers to challenge the effectiveness of the UI and dynamically integrate feedback. Built efficient and reusable front-end abstractions and systems. Participate in design and code reviews. Interacting with other team members to incorporate their innovations and vice versa. Analyzed system function and performance requirements to support design concepts.'
							)
						)
					),
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'p',
								{ className: _Timeline2.default['company'] },
								'Associated Northcliffe Digitial'
							),
							_react2.default.createElement(
								'p',
								{ className: _Timeline2.default['location'] },
							...
							_react2.default.createElement(
								'p',
								{ className: _Timeline2.default['description'] },
								'Involved in design and development of the project right from the scratch and followed graceful degradation approach for creating cross browser website with some of the HTML5 & CSS3 features. Also introduced Jasmine unit testing framework for JavaScript BDD testing and involved in developing the IPhone App version of the same product. Different themes of the same website can be seen at http://wowcher.metro.co.uk & http://wowcher.dailymail.co.uk.'
							)
						)
					),
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'p',
								{ className: _Timeline2.default['description'] },
								'As a 3 member UI team we were responsible for creating a cross browser compatible application and as the company insisted on creating a Rich UI, we have created our custom input controls (like dropdowns, input boxes, date picker etc) and this website includes lots of statistical data presentation using a third party framework called "Amcharts" (like pie chart, line chart, sparks). To achieve better page loading time, we have concentrated in performance measures like CDN, design patterns, image sprites, minified JS & CSS files etc.'
							)
						)
					),
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'p',
								{ className: _Timeline2.default['company'] },
								'Authoria Software Private Limited '
							),
							_react2.default.createElement(
								'p',
								{ className: _Timeline2.default['location'] },
							...
							_react2.default.createElement(
								'p',
								{ className: _Timeline2.default['description'] },
								'Played a major role in gathering the feature requirements, designing prototypes, and then developing the features. Also took care of back-end integration using Velocity. Here I played a vital role in defining the mock-up UIs according to the functional specification and implementing it. Since the product was built initially for IE6 & IE7, we reworked on the design to make it cross-browser compatible in a short period of time. As the application is growing drastically we introduced lots of reusable components to make the code manageable and introduced modernizr and other required Jquery plugins.'
							)
						)
					),
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'p',
								{ className: _Timeline2.default['description'] },
								'Played a vital role in understanding the requirement from the client and designing the pages from the scratch and adding various functionalities like User registration, News display, Product display & Ecommerce operations. As most of these most of these sites are into E- commerce, I worked on data integration with backend to achieve the E-commerce flow which involved lots of effort in JS, XML & XSLT. It was a very good learning opportunity for me to work with cross browser compatible websites from scratch.'
							)
						)
					)
				)
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"timeLine":"Timeline_timeLine_GJ_PbM","header":"Timeline_header_n-hidc","timeCard":"Timeline_timeCard_1p1AiV","company":"Timeline_company_3I6_oS","location":"Timeline_location_Gbmndl","description":"Timeline_description_W6IGGU","designation":"Timeline_designation_pcDbVm"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Resume = __webpack_require__(267);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Resume = __webpack_require__(268);
	...
	var Homepage = _react2.default.createClass({
		...
		render: function render() {
			...
			return _react2.default.createElement(
				'section',
				{ className: _Resume2.default['expertise'], id: 'resume' },
				_react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						'p',
						null,
						'You can grab the hard copy of my resume through below links.'
					),
					_react2.default.createElement(
						'a',
						{ target: '_blank', href: '/img/Antony-Britto.pdf', className: _Resume2.default['download'] },
						'DOWNLOAD PDF RESUME'
					),
					_react2.default.createElement(
						'a',
						{ target: '_blank', href: '/img/Antony-Britto.rtf', className: _Resume2.default['download'] },
						'DOWNLOAD RTF RESUME'
					)
				)
			);
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"expertise":"Resume_expertise_2xHbs2","header":"Resume_header_2FQY5K","download":"Resume_download_3BSGxz"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				'footer',
				{ className: _Footer2.default['footer'], id: 'contact' },
				_react2.default.createElement(
					'p',
					{ className: _Footer2.default['header'] },
					'Contact me at'
				),
				_react2.default.createElement(
					'ul',
					{ className: _Footer2.default['info'] },
					_react2.default.createElement(
						'li',
						null,
						...
						_react2.default.createElement(
							'a',
							{ href: 'mailto:antony.britto@gmail.com' },
							'antony.britto@gmail.com'
						)
					),
					_react2.default.createElement(
						'li',
						null,
						_react2.default.createElement('img', { src: '/img/phone.png' }),
						' +91 9880655650'
					)
				),
				_react2.default.createElement(
					'ul',
					{ className: _Footer2.default['social'] },
					_react2.default.createElement(
						'li',
						null,
						_react2.default.createElement(
							'a',
							{ target: '_blank', href: 'https://www.facebook.com/antony.britto.165' },
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'a',
							{ target: '_blank', href: 'https://in.linkedin.com/in/antonybritto' },
							_react2.default.createElement('img', { src: '../../img/linkedin.svg' })
						)
					),
					_react2.default.createElement(
						'li',
						...
						_react2.default.createElement(
							'a',
							{ target: '_blank', href: 'https://twitter.com/Britto_4u' },
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"footer":"Footer_footer_HJlsB9","header":"Footer_header_AzYlTo","info":"Footer_info_2B3-O8","social":"Footer_social_3fkiL7"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventsReducer = __webpack_require__(276);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function events() {
	  ...
	  switch (action.type) {
	    ...
	    case _constants.GET_EVENTS_REQUEST:
	      return Object.assign({}, state, {
	        loading: true,
	        error: false
	      });

	    case _constants.GET_EVENTS_SUCCESS:
	      return Object.assign({}, state, {
	        loading: false,
	        events: action.data,
	        error: false
	    ...
	    case _constants.GET_EVENTS_FAILURE:
	      return Object.assign({}, state, {
	        loading: false,
	        error: true,
	        errMsg: action.error
	    ...
	    case _constants.ADD_EVENTS_SUCCESS:
	      return Object.assign({}, state, {
	        loading: false,
	        addErrMsg: action.msg
	      });

	    case _constants.ADD_EVENTS_ERROR:
	      return Object.assign({}, state, {
	        loading: false,
	        addErrMsg: action.error
	      });
